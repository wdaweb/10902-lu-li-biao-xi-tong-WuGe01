    ...
    <header>
        <div class="header">
            <div class="container">
                ...
                <a class="headerWord btn btn-outline-secondary" style="border: 0px;" href="?do=log">登出</a>
                ...
                <a class="headerWord btn btn-outline-secondary" style="border: 0px;" href="?do=main">首頁</a>
            </div>
        </div>
    </header>
